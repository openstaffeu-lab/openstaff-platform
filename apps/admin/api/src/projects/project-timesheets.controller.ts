...
export class ProjectTimesheetsController {
  constructor(
    private readonly projectTimesheetsService: ProjectTimesheetsService,
  ) {}
  ...
  async generateTimesheet(
    ...
    return this.projectTimesheetsService.generateTimesheet(
      projectId,
      body,
      req.user,
    );
  ...
  async listProjectTimesheets(
    ...
    return this.projectTimesheetsService.listProjectTimesheets(
      projectId,
      req.user,
    );
  }
  ...
  async getProjectTimesheet(
    ...
    return this.projectTimesheetsService.getProjectTimesheet(
      projectId,
      timesheetId,
      req.user,
    );
  ...
  async updateTimesheetStatus(
    ...
    return this.projectTimesheetsService.updateTimesheetStatus(
      projectId,
      timesheetId,
      body,
      req.user,
  ...
  async calculatePayroll(
    ...
    return this.projectTimesheetsService.calculatePayroll(
      projectId,
      timesheetId,
      req.user,
    );
  ...
  async getPayroll(
    ...
    return this.projectTimesheetsService.getPayroll(
      projectId,
      timesheetId,
      req.user,
    );
